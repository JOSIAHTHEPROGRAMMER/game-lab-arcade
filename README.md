...
A collection of five browser-based HTML5 games, shipped by five student teams during the [ClickToStart Foundation](https://www.clicktostart.org/) AI Camp, with a single landing page (`index.html`) that links out to all of them.
